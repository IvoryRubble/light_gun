...
void draw() {
  ...
  drawDataPoint(dataConstrainX - p1x, dataConstrainY - p1y, p1color);  
  drawDataPoint(dataConstrainX - p2x, dataConstrainY - p2y, p2color);
  drawDataPoint(dataConstrainX - p3x, dataConstrainY - p3y, p3color);  
  drawDataPoint(dataConstrainX - p4x, dataConstrainY - p4y, p4color); 
