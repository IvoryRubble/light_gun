...
void PrintResultsRemote() {
  for (int i = 0; i < 4; i++) {
    remoteData.positionX[i] = positionX[i];
    remoteData.positionY[i] = positionY[i];
  }
  ...
  remoteData.buttonState1 = buttonState1;
  remoteData.buttonState2 = buttonState2;
  remoteData.isCamAvailable = isCamAvailable;
